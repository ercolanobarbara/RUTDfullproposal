...
from the underlying disc at the launch point. \connect{In this project we plan
...
\connect{Once the machinery to efficiently calculate chemical models
  of discs and their atmospheres/winds is in place, it will also be useful to
