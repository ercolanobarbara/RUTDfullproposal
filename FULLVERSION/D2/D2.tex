...
\item {\bf Companion inside the disk: The in-plane 2-D case}\\
  ...
  of a companion-disk interaction model? \connect{This sub-project will be
    ...
    making a strong collaboration beneficial\footexplainconnect.}
...
\connect{A key to the success of this project will be the comparison of the
  ...
  Dishoeck. Direct collaboration with the PhD students from project A1 is
  forseen to help with the comparison of our models with these ALMA data.
  The postdoc of B2 will be working a lot with 3-D diagnostic radiative
...
\connect{A connection to project B1 will be established when we intend to
