...
\noindent{\bf Authors:}\\
\begin{tabular}{ll}
{\textsf{Applicants:}}     & T.~Birnstiel (LMU) \\
                           & C.P.~Dullemond (ZAH~Heidelberg)\\
{\textsf{Co-Applicants:}}  & W.~Kley (U.~Tübingen), L.~Testi (ESO), E.~van Dishoeck (MPE/Leiden)\\
& Th.~Henning (MPIA) \\
%{\textsf{Cooperation Partner:}} &  \\
...
Both Applicants have extensive experience in the physics of particle growth
...
More recently, a collaboration between the Applicants of this proposal and
...
\begin{itemize}
  ...
  developed by the Applicant Prof.\ Dullemond. Scripts to directly run the
  \radmc dust radiative transfer calculation with the input from the
  dust evolution code of Applicant Dr.\ Birnstiel are available. These
...
\item Two-dimensional dust evolution results/parameterisation from the
  ERC-funded projects of the Applicant TB.
\end{itemize}

\subsubsection{Research Plan}

\paragraph{Phase I: Planetesimal formation and simple gas structures (months 1-12)}
\label{sec:phaseI}
...
fulfilled. Similar methods have already been used by the Applicants
...
\paragraph{Phase II: N-Body dynamics and planetesimal evolution (months 13-24)}
\label{sec:phaseII}
...
\paragraph{Phase III: Breaking the Symmetry (months 25-36)}
\label{sec:phaseIII}
...
% In addition to travel funds for conferences for the Applicants, regular
...
% Conferences Applicants     & \EUR{4 000} & \EUR{4 000} & \EUR{4 000} & \EUR{12 000}\\
% %Mutual working visits      & \EUR{2 500} & \EUR{2 500} & \EUR{2 500} & \EUR{7 500}\\
% \hline
% %                           & \EUR{8 500} & \EUR{8 500} & \EUR{9 500} & {\bf \EUR{26 500}}\\
%                            & \EUR{6 000} & \EUR{6 000} & \EUR{7 000} & {\bf \EUR{19 000}}\\
% \end{tabular}
% \end{center}
...
\textbf{Munich:} Only the Applicant TB will work directly on the project; group
members of the ERC Starting Grant group led by the Applicant TB will share results where
needed.\\
\textbf{Heidelberg:} Only the Applicant CPD.
...
We will collaborate with the ERC-funded group of the Applicant Dr.\ Birnstiel,
