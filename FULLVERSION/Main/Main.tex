...
\caption{\caphighlight{Left:} ALMA image of the disc around the young,
...
%Self-gravitating discs are thought to be important during the earliest
...
\begin{figure}
\centerline{\includegraphics[width=13cm]{figures/Connect_ProjProj.pdf}}
\caption{\label{fig-diagram-links}A matrix showing the links between the various
projects. The most important individual links are summarised in what
follows, but see text from individual sub-projects for further
details. {\bf A1-A2}: The
data-sets from projects A1 and A2 complement each other allowing a
constraining comparison with synthetic disk
populations obtained from the models developed in project B1. {\bf
  A1-B1 \& A1-B2}: the demographical properties of gas in disks will be an essential asset, in combination
with the outcome of project A2, for the benchmarks of the assumptions
and results of the models developed as part of projects B1 and
B2. {\bf A1-C1 \% A1-C2}: the dust properties in discs will provide  key
benchmarks for the models mainly developed in project C1,  but it will
also help constrain the initial conditions for models in project
C2. {\bf A1-D1} 
%\vspace{2em}\mbox{}\\
%\centerline{\includegraphics[width=16cm]{sizebar.eps}}
%\vspace{1em}\\
...
\todo{Kees to Barbara: Shall we simply replace the first and last twice-a-year meeting
with this one? Otherwise it gets a bit much, I think.}
