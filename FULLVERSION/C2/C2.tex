...
(e.g.\ Clarke et 2001), to date the only direct evidence of a
...
less success by photoevaporation models (e.g.\ Hartigan, Edwards \&
Ghandour 1995; Alexander 2008;  Rigliaco et al.\ 2013; Natta et al.\
2014; Pascucci \& Sterzik 2009; Schisano, Ercolano \& Guedel 2010;
Ercolano \& Owen 2010, 2016, Simon et al.\ 2016). These lines however
...
Ercolano \& Rosotti 2015, or the discussion in projects B1 and B2).   
...
2006). The work of Owen, Ercolano \& Clarke (2011b) could not however reproduce the
colour gradient of the observations, which show redder emission at
larger heights above the disc. Owen, Ercolano \& Clarke (2011b) suggested that the
...
Owen et al.\ (2011b) calculations, would reduce the population of
...
\begin{figure}
  ...
  \caption{Image from Owen, Ercolano \& Clarke (2011b): Synthetic images for
    ...
    \caphighlight{far right-hand column} displays a red green blue
...
planet-disc interactions (e.g. Paardekooper \& Mellema 2004, 2006; Zhu et
...
al.\ 2012; Lyra et al.\ 2009; Zhu et al.\ 2014). Grid codes are
...
In their recent work of Hutchison et al.\ (2016a,b) used a new algorithm to
...
of complexity this coupling should be performed in order to ensure
accurate results.  
...
\connect{At this stage it will also be interesting to connect with project C1,
...
(e.g.\ Rosotti, Ercolano et al.\ 2013, 2015),  for which the models
developed in project D1 will provide the starting conditions.}
...
\todo{Kees to Barbara: Shall I convert all your references to bibtex for
  ...
  handle. }
\todo{BARBARA TO KEES: YES PLEASEEEEE} 
...
Models for 2d dust evolution of the underlying disc will be provided
by the ERC-funded group of Dr Birnstiel. In the third year of the
Research Unit we will connect with project C1 to use the dust
distributions in the underlying discs. 
