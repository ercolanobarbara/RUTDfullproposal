...
ionising stellar flux \todo{Kees to Barbara:
Are you sure that Font et al.\ 2008 is the
right reference? I could not find it. Also the Hollenbach et al.~2004 I
am not sure about. Please clarify.}
\citep{2009ApJ...704..989A}. 
...
\todo{Kees to Barbara and Til: Shouldn't we also do the coupling to C1 the
  opposite direction? I mean: if the wind removes the gas, but the dust has
...
\citep[e.g.,][]{2013MNRAS.430.1392R, 2015MNRAS.454.2173R}, for which the models
