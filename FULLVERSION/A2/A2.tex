...
%%%%  Please edit
%
Thomas Preibisch: Accretion and X-ray activity in young stars (A2)}
%
%
%%%%%
...
\caption{\caphighlight{Left:} Reproduction of Fig.~1 from Hartmann et al.~(2016),
illustrating the main features of disk accretion in YSOs.
\caphighlight{Right:} Schematic illustration of the temporal evolution of the accretion rate
...
The \caphighlight{left plot} shows the case of a TTS with moderate X-ray luminosity
...
\newline
In the \caphighlight{right plot}, model curves for the case of a 10 times
...
%\subsubsection{Other publications}  \vspace{-1mm}

%\subsubsection{Patents} \vspace{-3mm}
...
\end{highlight}
%
\connect{The observational tests proposed here will provide a stringent
constraint to the models developed in projects B1 (PI Ercolano)\footexplainconnect. }
...
\connect{The results will
provide crucial new
constraints for theoretical models of the X-ray-disk interaction 
by photoevaporation, including those developed in project B1, and allow us to
...
constraints for theoretical models of the X-ray-disk interaction.
\connect{At this point we will work closely with the project B1 team
  to create synthetic disk populations from the 2D models to compare with
  the observational dataset from this project and the gas and dust
  demographics from project A2. The theoretical wind profiles will be
  used in conjunction with 
  a one-dimensional viscous model to follow the evolution of disks
  into the transition phase (see e.g. Owen, Ercolano \& Clarke, 2011).
  This is a unique and crucial test which will allow us for the first
  time us to directly constrain and calibrate the models.}
...
\bibitem[Baraffe et al.(2016)]{Baraffe16} Baraffe, I., Elbakyan, V.~G., Vorobyov, E.~I., \& Chabrier, G.\ 2016, \aap, 597, A19
...
%X-ray ionization rates in protoplanetary disks
...
%The link between disk dispersal by photoevaporation and the semimajor axis distribution of exoplanets
\bibitem[Ercolano \& Owen(2010)]{Ercolano10} Ercolano, B., \& Owen, J.~E.\ 2010, \mnras, 406, 1553
%Theoretical spectra of photoevaporating protoplanetary disks: an atlas of atomic and low-ionization emission lines
...
%On the lifetime of disks around late-type stars
\bibitem[Ercolano et al.(2015)]{Ercolano15} Ercolano, B., Koepferl, C., Owen, J., \& Robitaille, T.\ 2015, \mnras, 452, 3689 
%Far-infrared signatures and inner hole sizes of protoplanetary disks undergoing inside-out dust dispersal
\bibitem[Fairlamb et al.(2017)]{Fairlamb17} Fairlamb, J.~R., Oudmaijer, R.~D., Mendigutia, I., Ilee, J.~D., \& van den Ancker, M.~E.\ 2017, \mnras, 464, 4721
...
%Disk clearing of young stellar objects: evidence for fast inside-out dispersal
...
%Radiation-hydrodynamic models of X-ray and EUV photoevaporating protoplanetary disks

\bibitem[Owen, Ercolano \& Clarke(2011)]{Owen11} Owen, J.~E., Ercolano, B., \& Clarke, C.~J.\ 2011, \mnras, 412, 13
%Protoplanetary disk evolution and dispersal: the implications of X-ray photoevaporation

\bibitem[Owen et al.(2012)]{Owen12} Owen, J.~E., Clarke, C.~J., \& Ercolano, B.\ 2012, \mnras, 422, 1880 
%On the theory of disk photoevaporation
...
% We ask for \EUR{13 000} for travel expenses according to the following
% distribution:
% 
...
% In addition we ask for travel funds for conferences for the Applicant.\medskip
% 
% \begin{center}
...
% Conferences Applicant      & \EUR{2 000} & \EUR{2 000} & \EUR{2 000} & \EUR{6 000}\\
% \hline
...
\connect{This project will collect and re-derive X-ray and accretion properties
...
photoevaporation models of disks. These projects are lead by
Prof. Ercolano and Prof. Caselli.  The statistical analysis of the
