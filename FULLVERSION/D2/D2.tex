...
%%%%  Please edit
%
Cornelis Dullemond \& Wilhelm Kley: Non-axisymmetric structures in Transition Disks (D2)}
%
%
%%%%%
...
\item {\bf Companion inside the disk: The in-plane 2-D case}\label{subproj-inplane-2d}\\
  ...
  of a companion-disk interaction model? \connect{This sub-project will be
    ...
    eccentric orbits. Yet, from the technical perspective there are several similarities,
...
\item {\bf Companion inside the disk: The out-of-plane case}\label{subproj-inclined-3d}\\
  ...
  \connect{In Project D1 mild inclinations of multiple
    planetary mass companions are modelled, while here we focus on extreme
    inclinations of single stellar mass companions. In the latter case the star,
...
\connect{A strong collaboration within this Forschergruppe will be carried
  ...
  is not a goal of D1. From the point of view of objectives: D1 tries to find the 
