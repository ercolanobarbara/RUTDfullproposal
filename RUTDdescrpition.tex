...
timescale of a few Myr {\color{red} (REF??)}, which is comparable to
the timescales for planet formation by the core accretion process
{\color{red} (REF??)} and to migration timescales for giant planets
{\color{red} (REF??)}. This implies that the processes driving the
...
phenomenon (see e.g Owen 2015, {\color{red}Dong et al. 2016???}).  
...
with a forming giant planet (e.g. Zhu et al. 2011). However, since the
current models still fail to reproduce the Type 2 TD observations and
demographics (e.g. see {\color{red} Dong et al. 2016???}),
complementary with or in alternative to the classical planet scenario
a number of models have been proposed which include magnetohydrodynamics
effects (e.g. Wang \& Goodman, 2016) and/or dust evolution (Pinilla et
al. 2016). 

ALMA now allows to measure the bulk of the molecular gas {\it
...
Both types of TDs can \ provide complementary information about the planet formation process, as they
...
2008b; Hubber, Ercolano \& Dale, 2016), which is one of the main tools
...
{\color{red} On the observational side... } 
...
disc itself (e.g. {\color{red} D\"urmann \& Kley, 2016; Ercolano \&
  Rosotti, 2016, to cite only a few of the works coming from our team}, ). The
...
\mbox{}\vspace{1em}\\
\noindent{\bf \em Milestones and time schedule:}\vspace{0.8em}\\
...
\noindent{\bf \em Preconditions of the Research Unit}\\
