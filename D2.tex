...
\centerline{\Large\bf\Tcol Origin of complex non-axisymmetric structures in transition disks}
...
\subsection{\Tcol Preliminary work}
...
\subsubsection{\Tcol VLT-SPHERE observations of Type 2 TDs}
...
\caption{\label{fig-benisty} Polarized scattered light observations 
of the Type 2 TD HD100453. Left: Actual observations with VLT-SPHERE
in the I' band. Right: Synthetic model image made with the MCMax Monte
Carlo code. From: \citet{2016arXiv161010089B}.}
\end{figure}

\subsubsection{\Tcol ALMA observations of Type 2 TDs}
...
Left: The continuum (Stokes I component) at 850 $\mu$m showing the well
known arc-shaped structure believed to be dust trapped in a Rossby-vortex.
Right: The polarized intensity with the polarized direction overlayed.
From: \citet{2016ApJ...831L..12K}.}
\end{figure}
...
\subsubsection{\Tcol Preliminary models of out-of-plane companion-disk interaction}
...
\subsubsection{\Tcol Preliminary models of secondary disk formation}
...
\caption{\label{fig-kramer-4.1}Time sequence of off-center accretion of a
  ...
  snapshots (from left to right, top to bottom) are with $4.8\times 10^3$
  years intervals. The color bar is surface density in
...
\caption{\label{fig-kramer-4.12}Left: Scattered light synthetic image
  computed for a snapshot of the simulations of an off-center accretion of a
  small low-mass spherical Gaussian molecular cloud by a star. The color bas
  unit is mJy/arcsec$^2$. From: Bachelor Thesis by Manuel Kramer, Heidelberg
  University, 2016. Right: Observed scattered light image of the arc-shaped
  envelope around the Type 2 TD star AB Aurigae by P.~Kalas
...
\subsubsection{\Tcol Tools for the proposed project}
...
We have access to the bwFor computer cluster for astronomy in T\"ubingen. 


{\bf MORE ABOUT THE COMPUTER CLUSTER}
