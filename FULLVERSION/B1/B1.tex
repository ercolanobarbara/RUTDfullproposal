...
figure shows column densities in a quarter of the disc in
...
create synthetic transition disc population to check the occurrence of relic discs and
...
planet-disc interaction calculations. Project B1 will provide
project C1 team (PIs Dr.\ Birnstiel, Prof.\ Dullemond) with the hydrodynamical models for
photoevaporating discs, to allow them to investigate dust growth in
pressure bumps formed at the inner edge of the outer disc.}
