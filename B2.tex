...
\noindent{\bf Chemical models of protoplanetary discs}
...
\noindent{\bf Ionisation in discs}
...
%Sz$\ddot{\textsf u}$cs, L. et al. 2010, ApJ, 720, 1668 \\
%Sz$\ddot{\textsf u}$cs, L. et al. 2016, MNRAS, 460, 82 \\
...
\noindent {\bf Time-dependent chemistry.} It is unclear at this stage
...
% Please note that funds for your own temporary position (ﾃ｢竄ｬﾅ摘igene Stelleﾃ｢竄ｬ)
% are not to be included here; this belongs to the separate ﾃ｢竄ｬﾅ溺odule Temporary Positionﾃ｢竄ｬ.
