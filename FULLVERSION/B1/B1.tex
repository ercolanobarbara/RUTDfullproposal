...
What is certain, however, is that if MHD winds are indeed
...
\todo{Check if reference is the right one}
%(e.g.\ discussion in Armitage et al. 2013). 
...
\todo{Check if this is the right reference}
%(e.g.\ Hartmann 2008), 
until,
...
quickly eroded from the inside out 
...
calculations of X-ray + EUV driven photoevaporative winds to date 
\citep{2010MNRAS.401.1415O, 2011MNRAS.412...13O, 2012MNRAS.422.1880O},
%(Owen et al. 2010, 2011, 2012), 
as was described in the previous section. The models were run with a version of the {\sc
...
calculations of protoplanetary discs of 
\citet{2008ApJ...688..398E, 2009ApJ...699.1639E}.
%Ercolano et al. (2008, 2009). 
In that work it was shown that, within the
...
\connect{At this point a robust and well tested reduced chemical network should be
...
\todo{Kees to Barbara: In the original text it said Owen, Clarke \& Ercolano 2014, but I
could only find Owen, Ercolano \& Clarke 2014. Check.}
%(e.g.\ Owen, Clarke \& Ercolano 2014). 
