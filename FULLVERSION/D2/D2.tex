...
%%%%  Please edit
%
Cornelis Dullemond: Non-axisymmetric structures in Transition Disks (D2)}
%
%
%%%%%
...
\noindent{\bf Authors:}\\
\begin{tabular}{ll}
{\textsf{Applicants:}}              & C.P.~Dullemond (ZAH, Heidelberg), W.~Kley (T\"ubingen)\\
{\textsf{Co-Applicants:}}           & E.~van Dishoeck (MPE), T.~Henning (MPIA)\\
{\textsf{Collaboration Partners:}}  & L.~Testi (ESO), R.~Klessen (ZAH)\\
\end{tabular}
