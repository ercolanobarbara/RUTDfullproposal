...
{\textsf{Co-Applicants:}}       & B.~Ercolano (LMU), T.~Preibisch (LMU), T.~Henning (MPIA),\\
                                & E. van Dishoeck (Leiden, MPE)\\
{\textsf{Cooperation Partners:}}  & H.~Baobab~Liu (ESO),  J.M.~Carpenter (ALMA), A. Miotello (Leiden),  \\
                                  & I.~Pascucci (Arizona), M.~Tazzari (IoA), J.P.~Williams (Hawaii)\\
\end{tabular}
...
\begin{highlight}
A systematic assessment of the properties and evolution of dust and gas in TDs as compared with the rest of the disk population is required to constrain the nature of TDs and their relation to the global disk evolution and planet formation process. 
\end{highlight}
Four main properties need to be studied and can now be constrained 
