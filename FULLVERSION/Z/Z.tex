...
\subsection{Central Computing Facility}
We request a multicore machine to carry out part of the theoretical
work. This is necessary for mid-size production runs of some of the
bigger model calculations. This will give a unified computation
environment for the entire Research Unit, making it easier to
combine/connect models from different sub-projects. The
...
\subsection{Summary of Project Z}
