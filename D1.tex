...
\subsubsection{\Tcol On the accretion flow in Transitional Disks}
...
\caption{\label{fig:ecc-mdot-time} Radial density distribution 
({\bf top panel}) and time evolution of the mass accretion rate ({\bf bottom panel}) into the inner
hole of the disk for a $4 M_{Jup}$ planet located at 5.2au in a transitional disk.
Shown are curves for different thermodynamic treatments of the disk physics.
Taken from: \citet{2013A&A...560A..40M}} 
\end{figure}
%
\subsubsection{\Tcol On the dust distribution in the disk around HL Tau}
%
...
\caption{\label{fig:particles} 
Particle distribution near the inner low mass planetary core location for mm- (top left), cm- (top right),
dm- (bottom left), and m-sized (bottom right) particles at the end of the simulation. 
The velocity vectors of the particles with respect to the planet are shown and the colour
scale shows the relative radial velocity.
Taken from: \citet{2015A&A...584A.110P}} 
\end{figure}

\subsubsection{\Tcol Circumbinary disks and GPU-computing}
...
\citep{2016A&A...589A..10T} \todo{and will submit a new paper on the dynamics of circumbinary disks}.
...
\item
 {\bf Kley}, W. \& {Crida}, A. (2008) \, {\it Migration of protoplanets in radiative disks},
   Astronomy \& Astrophysics, {\bf 487}, 9.
...
\item
 {Ataiee}, S., {Pinilla}, P., {Zsom}, A., {\bf Dullemond}, C.P., {Dominik}, C. \& {Ghanbari}, J. (2013)
   ...
   Astronomy \& Astrophysics, {\bf 553}, L3.
\item
  {Picogna}, G. \& {\bf Kley}, W. (2015) \,
  {\it How do giant planetary cores shape the dust disk?. HL Tauri system},
  Astronomy \& Astrophysics, {\bf 584}, A110.
\item
  {\bf Kley}, W. \& {Haghighipour}, N. (2015) \,
...
\item
  ...
  Astronomy \& Astrophysics, {\bf 594}, A57.
\end{itemize}
...
\todo{(Part of this has been done already in section 2.3.3.  Shall we repeat here or just enter Names?
possible exchanges, etc...)}
